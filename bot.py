...
failure_message = os.environ.get('FAILURE_MESSAGE', 'Algo salia mal con la tarea, por favor intentar enviarla nuevamente.')
...
def handle_audio(message):
	...
	response = save_audio_deliver(None, message.from_user.id, file_info.file_path, count)
